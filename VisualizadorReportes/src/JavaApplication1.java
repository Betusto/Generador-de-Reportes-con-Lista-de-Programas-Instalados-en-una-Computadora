...
public class JavaApplication1 {
    ...
    public static void main(String[] args) {
        JavaApplication1 BaseDatos = new JavaApplication1();
        //BaseDatos.CargarPDF();
        BaseDatos.Visualizar();//Para el Administrador en esta se descargan los datos
    }
    ...
    public void Visualizar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                FileOutputStream fos = new FileOutputStream("Reporte-" + name +".pdf");
